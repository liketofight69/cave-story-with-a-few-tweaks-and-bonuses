...
#ifndef SECOND_ENEMY_H_
#define SECOND_ENEMY_H_
...
struct Secondenemy : public Damageable {
   Secondenemy(Graphics& graphics, Vector<units::Game> pos);
   ~Secondenemy();
...
private:
   ...
   const units::Game flight_center_x_;
